...
const treatSave = (article, articleDiv) => {
...
const treatArticle = article => {
    ...
    saveButton.addEventListener('click', () => treatSave(article, articleDiv));
